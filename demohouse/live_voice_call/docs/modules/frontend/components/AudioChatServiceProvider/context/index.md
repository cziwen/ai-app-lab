# frontend/src/components/AudioChatServiceProvider/context/index.ts

## 模块职责
- 负责 `components/AudioChatServiceProvider/context/index` 对应的前端能力（页面/组件/hook/类型/工具）。
...
## 对外接口（导出项）
L45: export const AudioChatServiceContext =

## 依赖与配置
- 关键导入（节选）：
L12: import {
L18: import type VoiceBotService from '@/utils/voice_bot_service';
