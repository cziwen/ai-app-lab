# frontend/src/components/AudioChatProvider/hooks/useMessageList.ts

## 模块职责
- 负责 `components/AudioChatProvider/hooks/useMessageList` 对应的前端能力（页面/组件/hook/类型/工具）。
...
## 对外接口（导出项）
L15: export const useMessageList = () => {
