...
## 模块职责
- 负责 `admin/api` 对应的前端能力（页面/组件/hook/类型/工具）。
...
## 对外接口（导出项）
L3: export type JobListItem = {
L10: export type JobDetail = {
L27: export type InterviewListItem = {
L42: export type InterviewDetail = {
L103: export const adminApi = {

## 依赖与配置
- 关键导入（节选）：
L1: import { API_URL } from '@/config/endpoints';
