...
## 模块职责
- 负责 `types` 对应的前端能力（页面/组件/hook/类型/工具）。
...
## 对外接口（导出项）
L12: export interface IMessage {
L17: export type WebResponse = {
L26: export type WebRequest = {
L32: export enum EventType {
L46: export interface IWebSocketResponse {
L51: export type BotErrorPayload = {
L58: export type JSONResponse = {
