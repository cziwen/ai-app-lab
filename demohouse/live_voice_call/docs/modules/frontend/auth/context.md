...
## 模块职责
- 负责 `auth/context` 对应的前端能力（页面/组件/hook/类型/工具）。
...
## 对外接口（导出项）
L42: export const SessionAuthProvider = ({ children }: PropsWithChildren) => {
L89: export const useSessionAuth = () => {

## 依赖与配置
- 关键导入（节选）：
L1: import {
L13: import { useLocation } from '@modern-js/runtime/router';
L14: import type { PermissionState } from '@/auth/types';
