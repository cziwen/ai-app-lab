# frontend/src/call-ui/components/CallControlBar.tsx

## 模块职责
- 负责 `call-ui/components/CallControlBar` 对应的前端能力（页面/组件/hook/类型/工具）。
...
## 对外接口（导出项）
L29: export const CallControlBar = ({

## 依赖与配置
- 关键导入（节选）：
L1: import type { CallControlAction, CallControlBarProps } from '@/call-ui/types';
