# frontend/src/call-ui/components/CallParticipantCard.tsx

## 模块职责
- 负责 `call-ui/components/CallParticipantCard` 对应的前端能力（页面/组件/hook/类型/工具）。
...
## 对外接口（导出项）
L4: export const CallParticipantCard = ({

## 依赖与配置
- 关键导入（节选）：
L1: import type { CSSProperties } from 'react';
L2: import type { CallParticipantCardProps } from '@/call-ui/types';
