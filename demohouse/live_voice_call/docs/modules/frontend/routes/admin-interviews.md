...
## 模块职责
- 负责 `routes/admin-interviews` 对应的前端能力（页面/组件/hook/类型/工具）。
...
## 对外接口（导出项）
L20: export const AdminInterviewsPage = () => {

## 依赖与配置
- 关键导入（节选）：
L1: import { FormEvent, useEffect, useMemo, useState } from 'react';
L2: import { API_URL } from '@/config/endpoints';
L3: import {
L9: import { AdminLoadingPage, AdminModal, AdminShell } from '@/admin/layout';
L10: import { useAdminAuth } from '@/admin/use-admin-auth';
