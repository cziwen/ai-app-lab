...
请介绍一下你的项目经验,项目经验,3分和7分,详细描述多个完整项目,仅描述单个项目,没有明确项目经验,0-5分,请说明命中点与改进建议
你如何处理团队冲突,团队协作,5分,主动化解并建立机制,能够妥善处理,回避或被动处理,0-5分,请给出1条改进建议
```
...
interface JobDetail {
  ...
  questions: Array<{
    ...
    score_format: string             // 分数要求
    comment_requirement: string      // 评语要求
  }>
}
```
...
**解决**：
- 确保 CSV 首行为：`问题,能力维度,评分分界线,最好标准,中等标准,最差标准,分数,评语要求`
- 使用 UTF-8 编码保存
- 避免表头字段前后有空格
...
请介绍一下你的项目经验,项目经验,3分和7分,详细描述多个完整项目,仅描述单个项目,没有明确项目经验,0-5分,请说明命中点与改进建议
你如何处理团队冲突,团队协作,5分,主动化解并建立机制,能够妥善处理,回避或被动处理,0-5分,请给出1条改进建议
描述一次技术难题的解决过程,问题解决,4分和8分,系统性分析并给出多种方案,能够解决但过程不清晰,未能有效解决,0-5分,请简要总结不足项
```
...
### 2. 处理特殊字符
```csv
"包含逗号,的题目",能力维度,评分分界线,"包含""引号""的标准",中等标准,最差标准,0-5分,请输出命中点
```

### 3. 避免空行和空白
```csv
问题,能力维度,评分分界线,最好标准,中等标准,最差标准,分数,评语要求
题目1,维度1,3分,标准1,标准2,标准3,0-5分,请给改进建议
题目2,维度2,5分,标准1,标准2,标准3,0-5分,请给改进建议
```
