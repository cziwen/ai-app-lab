...
## 模块职责
- 负责 `routes/page` 对应的前端能力（页面/组件/hook/类型/工具）。
...
## 对外接口（导出项）
L28: export default Index;

## 依赖与配置
- 关键导入（节选）：
L12: import React from 'react';
L14: import { AudioChatProvider } from '@/components/AudioChatProvider';
L15: import { AudioChatServiceProvider } from '@/components/AudioChatServiceProvider';
L16: import { CallInterviewPage } from '@/call-ui';
