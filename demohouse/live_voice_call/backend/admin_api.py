    ...
    async def get_interview(token: str, _admin: Dict[str, Any] = Depends(require_admin)) -> Dict[str, Any]:
        ...
        response: Dict[str, Any] = {
            "interview": {
                ...
                "finalize_source": detail.get("finalize_source", "fallback"),
                ...
                "partial_reason": str(detail.get("partial_reason", "") or ""),
                "disconnect_completed": bool(detail.get("disconnect_completed", False)),
                "unanswered_count": int(detail.get("unanswered_count", 0) or 0),
                "job": detail["job"],
